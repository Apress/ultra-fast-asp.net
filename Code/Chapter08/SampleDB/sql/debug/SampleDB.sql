...
CREATE DATABASE [$(DatabaseName)]
    ON 
    PRIMARY(NAME = [SampleDB], FILENAME = N'$(DefaultDataPath)SampleDB.mdf')
    LOG ON (NAME = [SampleDB_log], FILENAME = N'$(DefaultDataPath)SampleDB_log.ldf') COLLATE SQL_Latin1_General_CP1_CS_AS
GO
